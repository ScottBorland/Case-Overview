...
function OffenceNode({ data }: NodeProps<OffenceNodeType>) {
  ...
  if (compact) return (
    <div style={{ ...nodeCardGlow(colors.offence), padding: '7px 10px', width: 180, maxWidth: 180 }}>
      <div style={nodeRibbonCompact(colors.offence)} />
      <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
        <div style={{ flex: 1 }}>
          <div style={{ ...nodeEyebrowTint(colors.offence), fontSize: 9 }}>OFFENCE</div>
          <div style={{ ...nodeTitle, fontSize: 11 }}>{offence !== '—' ? offence : 'Offence'}</div>
        </div>
        <button
  ...
  return (
    ...
    >
      <div style={nodeRibbon(colors.offence)} />
      <div style={{ ...nodeEyebrowTint(colors.offence) }}>OFFENCE</div>
